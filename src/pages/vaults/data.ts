...
export interface VaultData {
  ...
  /** LIVE vaults only: mock snapshot numbers for the media block */
  snapshot?: { price: number; supply: string };
...
export const VAULTS: VaultData[] = [
  {
    ...
    approach: [
      "The vault opens an equivalent long on the Tesla equity perp the moment you deposit. Delta target 1.0, enforced by a band check every block window, rebalanced permissionlessly by keepers who earn a bounty for it.",
      FUNDING_PARA,
    ],
    stats: [
      {
        ...
        suffix: "%",
        decimals: 2,
        caption: "Backing ratio, supply x price covered every block since deployment",
      },
      { value: 0, caption: "Redemptions ever gated, queued, or delayed" },
    ],
    resultsCopy:
      "Deposit USDC, receive uTSLA at oracle price in the same transaction. Burn uTSLA, receive USDC back the same way. The vault's solvency math is public every block, so none of this requires trusting us.",
    quote: {
    ...
    snapshot: { price: 412.38, supply: "128,540" },
  },
  {
    slug: "unvda",
    name: "uNVDA",
    ...
    approach: [
      "The vault opens an equivalent long on the Nvidia equity perp the moment you deposit. Delta target 1.0, enforced by a band check every block window, rebalanced permissionlessly by keepers who earn a bounty for it.",
      FUNDING_PARA,
    ],
    stats: [
      {
    ...
    resultsCopy:
      "Deposit USDC, receive uNVDA at oracle price in the same transaction. Burn uNVDA, receive USDC back the same way. The vault's solvency math is public every block, so none of this requires trusting us.",
    quote: {
    ...
    snapshot: { price: 188.42, supply: "204,318" },
  },
  {
    slug: "uspx",
    name: "uSPX",
    ...
    approach: [
      "When the vault deploys, it opens an equivalent long on the index perp the moment you deposit. Delta target 1.0, enforced by a band check every block window, rebalanced permissionlessly by keepers who earn a bounty for it.",
      FUNDING_PARA,
    ],
    stats: [
      {
      ...
      { value: 0, caption: "Redemption gates or queue mechanisms in the vault design" },
    ],
    resultsCopy:
      "Deposit USDC, receive uSPX at oracle price in the same transaction. Burn uSPX, receive USDC back the same way. Solvency math will be public every block from deployment, so none of this requires trusting us.",
    quote: {
  ...
  },
  {
    ...
    approach: [
      "When the vault deploys, it opens an equivalent long on the Nasdaq 100 index perp the moment you deposit. Delta target 1.0, enforced by a band check every block window, rebalanced permissionlessly by keepers who earn a bounty for it.",
      FUNDING_PARA,
    ],
    stats: [
      {
    ...
    resultsCopy:
      "Deposit USDC, receive uQQQ at oracle price in the same transaction. Burn uQQQ, receive USDC back the same way. Solvency math will be public every block from deployment, so none of this requires trusting us.",
    quote: {
  ...
  },
  {
    ...
    approach: [
      "When the vault deploys, it opens an equivalent long on the Apple equity perp the moment you deposit. Delta target 1.0, enforced by a band check every block window, rebalanced permissionlessly by keepers who earn a bounty for it.",
      FUNDING_PARA,
    ],
    stats: [
      {
    ...
    resultsCopy:
      "Deposit USDC, receive uAAPL at oracle price in the same transaction. Burn uAAPL, receive USDC back the same way. Solvency math will be public every block from deployment, so none of this requires trusting us.",
    quote: {
