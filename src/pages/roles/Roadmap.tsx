...
const PHASES = [
  {
    ...
    status: "Live",
    live: true,
    title: "uTSLA + uNVDA vaults",
    copy: "Deepest books first. Mint, redeem, and the public solvency dashboard.",
  },
  {
    tag: "C2",
    status: "Next",
    live: false,
    title: "uSPX + uQQQ index certs",
    copy: "LP incentives and lending-market integrations.",
  },
  {
    tag: "C3",
    status: null,
