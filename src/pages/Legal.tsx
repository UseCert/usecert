  ...
  "terms-of-service": {
    ...
    sections: [
      ...
      },
      {
        heading: "4. Risks",
        paragraphs: [
          "Using the protocol involves risk, including smart contract risk, oracle risk, market and funding risk, dependence on a single trading venue and a single attester, and the risk that backing mechanisms behave differently under extreme conditions. An insurance pool (InsuranceStaking) is deployed; it is unaudited and its deposits are capped at 10,000 USDG. Staking in it means your stake can be drawn, in part or in full, to cover a vault's shortfall, after a public, capped draw proposed by the protocol's 2-of-3 Safe. CERT staking (CertStaking) is a separate, unaudited contract capped at 10,000,000 CERT: it pays a share of fee income only when funded, and staked CERT is never drawn to cover a loss. You are responsible for understanding these risks before minting, holding or redeeming. Nothing in the interface constitutes a guarantee of value.",
        ],
      },
      {
